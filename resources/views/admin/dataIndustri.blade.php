                            ...
                            <div class="card-header  ">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 text-lg-end mt-3 mt-lg-0">
                                        ...
                                        <a href="/tambah-industri" class="btn btn-primary me-2">Tambah Data</a>
                                    ...
                                    <table class="table text-nowrap mb-0 table-centered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>PT. Inovindo</td>
                                                <td>inovindodigitalmedia@gmail.com</td>
                                                <td><span class="badge bg-success">Aktif</span></td>
                                                <td>
                                                    <a class="btn btn-warning" href="/edit-industri" role="button">Edit</a>
