...
<head>
    ...
    <!-- Favicon icon-->
    <link rel="shortcut icon" type="image/x-icon" href="dashuipro/assets/images/favicon/favicon.ico" />

    <!-- Color modes -->
    <script src="dashuipro/assets/js/vendors/color-modes.js"></script>

    <!-- Libs CSS -->
    <link href="dashuipro/assets/libs/bootstrap-icons/font/bootstrap-icons.min.css" rel="stylesheet" />
    <link href="dashuipro/assets/libs/%40mdi/font/css/materialdesignicons.min.css" rel="stylesheet" />
    <link href="dashuipro/assets/libs/simplebar/dist/simplebar.min.css" rel="stylesheet" />

    <!-- Theme CSS -->
    <link rel="stylesheet" href="dashuipro/assets/css/theme.min.css">
